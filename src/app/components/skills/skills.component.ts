...
export class SkillsComponent{
  sections: Map<string, string[]> = new Map([
      ...
      ["frameworks & libraries", ["Angular", "React", "Next", "Node", "Flask", ".NET Framework", "Express", "Angular Material", "Bootstrap",  "Tailwind css", "MUI", "Tensorfiow", "Pytorch", "Scikit-learn", "Matplotlib", "Pandas"]],
